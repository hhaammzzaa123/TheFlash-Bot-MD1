...
const eGataCoins = () => { return '🐱 BotaCoins' }
const eGataTickers = () => { return '🎫 Bot Tickers' } 
...
const smsJBInfo2 = () => { return `💖 *الوظيفة مستقرة ، إذا واجهت أي إزعاج ، فاتصل بالبريد: hamzahesham762@gmail.com*\n💝 *يمكنك تقديم تبرع طوعي عن طريق PayPal: ${global.paypal}*\n\n*شكرا جزيلا على الدعم ${global.packname}*`}
...
const smsContacto4 = () => { return 'جهة اتصال 𝐌𝐑 𝐇𝐀𝐌𝐙𝐀 𝐁𝐎𝐓 الرسمية 🐈'}
